...
@WebServlet(name = "WorkerSearchTwoServlet", urlPatterns = "/workerSearchTwoServlet")
public class WorkerSearchTwoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            if(user.getRole().equals(Role.DISPATCHER)){
                ...
                String jsonWorker = "";
                if(br!=null){
                    jsonWorker=br.readLine();
                }
                Gson gson = new Gson();
                Worker workerGson = gson.fromJson(jsonWorker,Worker.class);
                Worker worker = workerService.getWorkerName(workerGson.getName(),workerGson.getSurname());
                String jsons = gson.toJson(worker);
